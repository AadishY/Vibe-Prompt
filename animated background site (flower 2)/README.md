# 🌸 Animated Background Site 2 — Vantage (Full-Viewport Video Poster)

> **Example Live Site / Applet:** [Click Here](https://ai.studio/apps/2818b48f-fc8f-4436-a5a6-7d5ed90445e7?fullscreenApplet=true)  
> **Concept:** Vantage — Stop Digging Through Dashboards  
...
![Vantage Animated Flower Hero Screenshot](./preview.webp)

### 🎥 Live Video Demonstration
<video src="https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260808_064556_051587f1-74a1-4336-8c05-4dde3594ed05.mp4" poster="./preview.webp" controls autoplay loop muted playsinline width="100%">
...
*Pixel-faithful full-viewport dark landing poster featuring edge-to-edge animated floral background video, Reference Sans & Display typography, bottom-right glass demo card, and choreography entrance timeline.*

---

## 💻 The Complete Prompt (Copy & Paste)

Copy and paste the exact prompt blueprint below into your AI coding assistant (Claude, Cursor, v0, ChatGPT, Gemini):
