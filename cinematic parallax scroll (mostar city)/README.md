# 🏞️ Cinematic Parallax Scroll — Mostar City Story
## **Example Live Site :** [Click Here](https://ai.studio/apps/5a911177-9ef0-483f-8b67-ce7f532e5e9f?fullscreenApplet=true) 
> **Concept:** Mostar City — Three-Screen Cinematic Parallax Scroll Story  
> **Stack:** Vanilla HTML5, CSS3, JavaScript (Zero Frameworks, Zero Build Step)  
> **Ideal Coding Assistants:** [Claude 3.7 Sonnet / Opus](https://claude.ai/) • [Google AI Studio](https://aistudio.google.com/) • [Cursor](https://www.cursor.com/) • [v0.dev](https://v0.dev/)
...
![Mostar City Cinematic Parallax Preview](./preview.webp)

*Multi-layered 3D scroll experience featuring sticky sticky stage viewports, smoothstep/lerp interpolation, remote transparent PNG layer assets, infinite carousel math, and typography in Ogg Medium.*

---

## 💻 The Complete Prompt (Copy & Paste)

Copy and paste the prompt blueprint below into your AI coding assistant (Claude, Cursor, v0, ChatGPT, Gemini):
...
- 0–650px: MOSTAR rises -210px while scaling to 0.92 and fading out; intro paragraph + 3 cream pills sink +90px and fade. Sky, back-stack, bridge, and splitframes drift subtly with the pointer the whole time.
- 560–1620px: bridge widens 67.2vw → 105vw, its bottom lifts 5vh → -8vh, then it launches up -760px and scales +0.46 on exit. The two splitframe halves part symmetrically to ∓46vw (eased enter^1.5), rise -180px, scale +0.74. The frame-two river close-up fades in behind them. Global blur ramps to 14px, brightness drops ~25.5%, and the blue 74,181,224 shade gradient rises to alphas 0.465 / 0.42 / 0.51. Bridge story panel fades in at top:60%, sliding from +58px to -86px.
- 1760–2700px: bazaar layer gains +0.18 saturation while the bridge panel exits; bazaar story panel fades in at top:29% with the same +58px → -86px slide and its Open old town notes pill.
- 2760–3560px: the sights slider flies in from 420vw on X (enter^1.55 easing), becoming visible past 0.01, counter-scaled by 1 / backScale so cards stay screen-true while the back stack keeps zooming; its top is solved so cards sit at clamp(innerHeight*0.19, 112, 220) - 50 px on screen.
- 3360–3660px: the two round ← → buttons fade in at left:48px beneath the cards and become clickable only past 0.98. Prev/next and card clicks slide the track with the 640ms cubic-bezier(0.22, 1, 0.36, 1) transition and loop seamlessly via the 3-set clone + instant-jump normalization.
