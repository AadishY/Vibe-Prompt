# ⚡ Animated Background Site — Intelligence Designed To Evolve (Cool)

> **Example Live Site / Applet:** [Click Here](https://ai.studio/apps/a9a1be82-7dfc-4923-8521-ec0816e01fd0?fullscreenApplet=true)  
> **Concept:** Intelligence Designed To Evolve — Single-Viewport Video Background Landing Page  
...
![Intelligence Evolve Animated Hero Screenshot](./preview.webp)

### 🎥 Live Video Demonstration
<video src="https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260809_012548_ef22562c-c0ae-4816-ad9d-f8922af4e6a7.mp4" poster="./preview.webp" controls autoplay loop muted playsinline width="100%">
...
*Single-viewport full-bleed video background landing page featuring retro dot-matrix typography, animated enterprise trust pills, glowing pill CTA, and dynamic count-up telemetry stats.*
...
```text
Rebuild this as a single-viewport, full-bleed video-background landing page using static HTML + CSS + vanilla JS (no framework). Match the current implementation exactly.
...
Entrance animation:
- Header: slideDown 0.7s cubic-bezier(0.22, 1, 0.36, 1) both (from opacity 0, translateY(-18px) → settled)
...
- Soft white glow: 0 0 0 1px rgba(255,255,255,0.15), 0 0 22px rgba(255,255,255,0.32), 0 0 44px rgba(255,255,255,0.12)
...
- Count-up JS: easeOutCubic, duration 1500 + i*80ms, start offset 480 + i*90ms, once via IntersectionObserver threshold 0.25
