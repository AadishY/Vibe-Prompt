# 🚀 Cinematic Space-Travel Landing Page (Space Fluid)

## **Example Live Site / Applet:** [Click Here](https://ai.studio/apps/0ab08df0-fff5-4a78-9f8f-9bdf93aa141b?fullscreenApplet=true)  
> **Concept:** Cinematic Space-Travel & Capabilities Landing Page  
...
### 🖼️ Still Image Previews

#### Section 1: Hero — Space Voyage
![Section 1 Hero Space Voyage Screenshot](./preview.webp)

#### Section 2: Capabilities — Production Evolved
![Section 2 Capabilities Production Evolved Screenshot](./preview1.webp)

### 🎥 Live Video Demonstrations

#### Section 1: Hero Video (Deep Space Voyage)
<video src="https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260418_080021_d598092b-c4c2-4e53-8e46-94cf9064cd50.mp4" poster="./preview.webp" controls autoplay loop muted playsinline width="100%">
...
#### Section 2: Capabilities Video (Fluid Atmosphere)
<video src="https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260418_094631_d30ab262-45ee-4b7d-99f3-5d5848c8ef13.mp4" controls loop muted playsinline width="100%">
...
*Two-section landing experience featuring looping background video crossfades, a shared liquid-glass design system, word-by-word blur-in text, and Framer Motion entrance choreographies.*
...
- Left: 44×44 nested liquid-glass square (rounded-[0.75rem]) with a white Material Icons SVG (fill currentColor, h-6 w-6 text-white). Use Material icons:
...
- Framer Motion dev warnings about list keys can be suppressed with a console.error filter wrapper.
```
